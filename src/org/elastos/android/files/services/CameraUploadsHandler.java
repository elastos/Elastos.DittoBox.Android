...
import org.elastos.android.datamodel.CameraUploadsSyncStorageManager;
import org.elastos.android.db.OCCameraUploadSync;
...
public class CameraUploadsHandler {
    ...
    private PreferenceManager.CameraUploadsConfiguration mCameraUploadsConfig; // Camera uploads configuration, set by the user
    ...
    public void setCameraUploadsConfig(PreferenceManager.CameraUploadsConfiguration mCameraUploadsConfig) {
