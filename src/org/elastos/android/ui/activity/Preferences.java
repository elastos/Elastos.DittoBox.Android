...
import org.elastos.android.files.services.CameraUploadsHandler;
...
public class Preferences extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        org.elastos.android.db.PreferenceManager.CameraUploadsConfiguration configuration = org.elastos.android.db.PreferenceManager.
    ...
    private void loadCameraUploadsSourcePath() {
        ...
        mSourcePath = appPrefs.getString(
                ...
                org.elastos.android.db.PreferenceManager.CameraUploadsConfiguration.DEFAULT_SOURCE_PATH
        );
        if (mPrefCameraUploadsSourcePath != null) {
            mPrefCameraUploadsSourcePath.setSummary(
                    DisplayUtils.getPathWithoutLastSlash(mSourcePath)
