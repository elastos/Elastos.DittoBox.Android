...
import org.elastos.ditto.files.services.CameraUploadsHandler;
...
public class Preferences extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        org.elastos.ditto.db.PreferenceManager.CameraUploadsConfiguration configuration = org.elastos.ditto.db.PreferenceManager.
    ...
    private void loadCameraUploadsSourcePath() {
        ...
        mSourcePath = appPrefs.getString(
                ...
                org.elastos.ditto.db.PreferenceManager.CameraUploadsConfiguration.DEFAULT_SOURCE_PATH
        );
        if (mPrefCameraUploadsSourcePath != null) {
            mPrefCameraUploadsSourcePath.setSummary(
                    DisplayUtils.getPathWithoutLastSlash(mSourcePath)
